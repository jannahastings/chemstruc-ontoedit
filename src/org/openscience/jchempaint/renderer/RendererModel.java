...
/**
 * Model for {@link org.openscience.jchempaint.renderer.Renderer} that contains settings for drawing objects.
 *
 * @cdk.module render
 * @cdk.svnrev $Revision$
 */
public class RendererModel implements Serializable, Cloneable {
     ...
     *
     * @param fontStyle a member of the enum in {@link org.openscience.jchempaint.renderer.font.IFontManager}
     */
    ...
    /**
     * Returns the {@link java.util.Map} used for coloring substructures.
     *
     * @return the {@link java.util.Map} used for coloring substructures
     */
    ...
    /**
     * Sets the {@link java.util.Map} used for coloring substructures
     *
     * @param colorHash
     *            the {@link java.util.Map} used for coloring substructures
     */
