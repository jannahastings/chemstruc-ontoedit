...
public class JCPMenuTextMaker {
    ...
    public void init(String guistring){
        ...
        entries.put("fragmentGroupMenu", GT._("Fragment"));
        entries.put("setFragmentRoot", GT._("Set as Fragment Root"));
        entries.put("setAttachedGroup", GT._("Set as Attached Group"));
        entries.put("fragmentGroupPopup",GT._("Fragment"));
    }
