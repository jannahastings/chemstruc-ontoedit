...
public class Convertor {
    ...
    public static void main(String[] args) {
        try {
            ...
            BufferedObjects.AtomContainerBuffer acBuffer=Convertor.fromCDKAtomContainer(ac);
           BufferedObjects.AtomContainerBuffer acBuffer2= BufferedObjects.AtomContainerBuffer.parseFrom(acBuffer.toByteArray());
            acBuffer2.getAllFields();
        } catch (Exception e) {
            e.printStackTrace();
        }
